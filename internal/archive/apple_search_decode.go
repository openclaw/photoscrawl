...
func leoCategoryToPhotos8(category int) (int, bool) {
	mapped, ok := leoCategoriesToPhotos8[category]
	return mapped, ok
}

// Apple changed category IDs with leo.sqlite; osxphotos defines this mapping
// in _photosdb_process_searchinfo.py:LEO_CATEGORY_TO_PHOTOS8.
var leoCategoriesToPhotos8 = map[int]int{
	1010: 1100,
	1020: 1101,
	1030: 1103,
	1040: 1104,
...
var appleSearchCategoriesPhotos8 = map[int]appleSearchCategory{
